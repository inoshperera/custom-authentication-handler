...
public class CustomAuthenticatorException extends Exception {
    public CustomAuthenticatorException() {
        super();
    }
    ...
    public CustomAuthenticatorException(Throwable cause) {
        super(cause);
    }

    protected CustomAuthenticatorException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
